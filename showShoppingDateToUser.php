...
{
    include_once 'showShoppingDateToUserFetch.php';
            ...
            <div class="static-content">
                ...
                <div class="page-content">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="showShoppingDateToUser.php">User Shopping Date Details</a></li>
                                        ...
                                        <table class="table table-striped table-fill">
                                            ...
                                            <tr>
                                                <td style="font-weight: bolder;font-size: larger;">
                                                    <?php
                                                    $userShoppingDateDetails=new userShoppingDateDetails();
                                                    echo $userShoppingDateDetails->user_next_shopping_date($_SESSION['userID']);
                                                    ?>
                                                </td>
                                                <!--<td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-md-10 col-sm-12 col-xs-12">
                                                        <table class='table table-striped table-fill'>
                                                            ...
                                                            <?php
                                                            $userShoppingDateDetails->user_shopping_list($_SESSION['userID']);
                                                            ?>
                                                            </tbody>
                                                        </table>
                                                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="panel panel-primary" data-widget='{"draggable": "false"}'>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <?php
                                            $totalMember=count($userShoppingDateDetails->return_group_members_name($_SESSION['groupID']));
                                                ...
                                                <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                                                    <div class="panel panel-info" data-widget='{"draggable": "false"}'>
                                                        <div class="panel-heading">
                                                            ...
                                                            <h2><?php
                                                                echo $userShoppingDateDetails->return_group_members_name($_SESSION['groupID'])[$i];
                                                                ?>
                                                            </h2>
                                                            <div class="options">
                                                            </div>
                                                        ...
                                                        <div class="panel-body no-padding">
                                                            <table class='table table-striped table-fill'>
                                                                ...
                                                                <tbody>
                                                                <?php
                                                                $userShoppingDateDetails->group_members_bazar_date_list($userShoppingDateDetails->return_group_member_id()[$i]);
                                                                ?>
                                                                </tbody>
                                                            </table>
                                                        </div>
...
?>
<script type="text/javascript" src="showShoppingDateTouser.js"></script>
<?php
}
else{
