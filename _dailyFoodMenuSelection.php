...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=.7" charset="UTF-8">
...
?>
    ...
    <div class="my_form">
        <form name="foodMenuInputForm" method="post">
            ...
            <p class="text_box">
                <label for="item">ITEM <span class="item_number">1</span></label>
...
/*    if($itemCount==2){
                $addColumnDynamically="ALTER TABLE foodmenu ADD COLUMN item_name2 VARCHAR (40) NOT NULL AFTER item_name1";
                mysqli_query($conn,$addColumnDynamically);

            }
    else if($itemCount==3){
        $addColumnDynamically="ALTER TABLE foodmenu ADD COLUMN item_name3 VARCHAR (40) NOT NULL AFTER item_name2";
        mysqli_query($conn,$addColumnDynamically);
    }
    else if($itemCount==4){
        $addColumnDynamically="ALTER TABLE foodmenu ADD COLUMN item_name4 VARCHAR (40) NOT NULL AFTER item_name3";
        mysqli_query($conn,$addColumnDynamically);
    }
    else if($itemCount==5){
        $addColumnDynamically="ALTER TABLE foodmenu ADD COLUMN item_name5 VARCHAR (40) NOT NULL AFTER item_name4";
        mysqli_query($conn,$addColumnDynamically);
    }
    else if($itemCount==6){
        $addColumnDynamically="ALTER TABLE foodmenu ADD COLUMN item_name6 VARCHAR (40) NOT NULL AFTER item_name5";
        mysqli_query($conn,$addColumnDynamically);
    }
    mysqli_close($conn);
    ...
    if($itemCount==1){
        if($allValue[0]!="" && $dateforfoodmenu !="" && $timePickingforfoodmenu !="") {
            $addingColumnValueDynamically = "INSERT INTO foodmenu(manager_id,inserted_date,inserted_time,item_name1)
                VALUES ('$mangerID','$dateforfoodmenu','$timePickingforfoodmenu','$allValue[0]');";
            mysqli_query($conn, $addingColumnValueDynamically);
        }
        else{
            echo "This data can not be inserted";
        }
    }
    else if($itemCount==2){
        if($allValue[0]!="" && $dateforfoodmenu!="" && $timePickingforfoodmenu!="") {

            $addingColumnValueDynamically = "INSERT INTO foodmenu(manager_id,inserted_date,inserted_time,item_name1,item_name2)
                VALUES ('$mangerID','$dateforfoodmenu','$timePickingforfoodmenu','$allValue[0]','$allValue[1]');";
            mysqli_query($conn, $addingColumnValueDynamically);
        }
        else{
            echo "Empty Value can not be inserted";
        }
    }
    else if($itemCount==3){
        if($allValue[0]!="" && $dateforfoodmenu!="" && $timePickingforfoodmenu!="") {

            $addingColumnValueDynamically = "INSERT INTO foodmenu(manager_id,inserted_date,inserted_time,item_name1,item_name2,item_name3)
                VALUES ('$mangerID','$dateforfoodmenu','$timePickingforfoodmenu','$allValue[0]','$allValue[1]','$allValue[2]');";
            mysqli_query($conn, $addingColumnValueDynamically);
        }
        else{
            echo "Empty Value can not be inserted";
        ...
        if($allValue[0]!="" && $dateforfoodmenu!="" && $timePickingforfoodmenu!="") {
            ...
            $addingColumnValueDynamically = "INSERT INTO foodmenu(manager_id,inserted_date,inserted_time,item_name1,item_name2,item_name3,item_name4)
                VALUES ('$mangerID','$dateforfoodmenu','$timePickingforfoodmenu','$allValue[0]','$allValue[1]','$allValue[2]','$allValue[3]');";
            mysqli_query($conn, $addingColumnValueDynamically);
        }
        else{
            echo "Empty Value can not be inserted";
        ...
        if($allValue[0]!="" && $dateforfoodmenu!="" && $timePickingforfoodmenu!="") {
            ...
            $addingColumnValueDynamically = "INSERT INTO foodmenu(manager_id,inserted_date,inserted_time,item_name1,item_name2,item_name3,item_name4,item_name5)
                VALUES ('$mangerID','$dateforfoodmenu','$timePickingforfoodmenu','$allValue[0]','$allValue[1]','$allValue[2]','$allValue[3]','$allValue[4]');";
            mysqli_query($conn, $addingColumnValueDynamically);
        }
        else{
            echo "Empty Value can not be inserted";
        ...
        if($allValue[0]!="" && $dateforfoodmenu!="" && $timePickingforfoodmenu!="") {
            ...
            $addingColumnValueDynamically = "INSERT INTO foodmenu(manager_id,inserted_date,inserted_time,item_name1,item_name2,item_name3,item_name4,item_name5,item_name6)
                VALUES ('$mangerID','$dateforfoodmenu','$timePickingforfoodmenu','$allValue[0]','$allValue[1]','$allValue[2]','$allValue[3]','$allValue[4]','$allValue[5]');";
            mysqli_query($conn, $addingColumnValueDynamically);
        }
        else{
            echo "Empty Value can not be inserted";
