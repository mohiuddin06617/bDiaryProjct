            ...
            <div class="static-content">
                <div class="page-content">
                    ...
                    <div class="container-fluid">
                        <?php require "shopperSelectionFetch.php"; ?>
                        <div class="row">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-lg-6 col-md-4 col-sm-10 col-xs-10">
                                            <form method="post" role="form" id="shoppingPersonSelection"
                                                ...
                                                $groupMemberId = array();
                                                echo '<div class="form-group black-text-color"><label for="selectedShopper" class="control-label">Select Shopper From Below User List : </label>';
                                                if ($memberList->num_rows > 0) {
                                                    $select = '<select name="selectedShopper" class="form-control input-lg black-text-color" id="selectedShopper"><option value="0">Select User From Below</option>';
                                                    while ($member = $memberList->fetch_assoc()) {
                                                        /*                                                        echo "<option value='".$row['id']."' id='selectedShopper'>".$row['firstname']." ".$row['lastname']."</option>";*/
                                                        $select .= '<option value="' . $member['id'] . '">' . ucwords($member['firstName'] . " " . $member['lastName']) . '</option>';
                                                ...
                                                <div class="form-group form-horizontal">
                                                    <label for="selectedDateForShopper" class="control-label">Select Date Below : </label>
                                                    <input type="text" id="selectedDateForShopper"
                                                           class="dateSlector form-control black-text-color"
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    <div class="panel panel-primary"
                                                        ...
                                                        <div class="panel-body no-padding">
                                                            ...
                                                            $shopperSelectionFetch->get_shopping_date_by_id($groupMemberId[$i]);
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
...
<script src="shopperSelection.js"></script>
