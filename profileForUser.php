...
<head>
    ...
    include_once "profileForUserFetch.php";
    $profileForFetch = new profileForUserFetch();
            ...
            <div class="static-content">
                <div class="page-content">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="profileForUser.php">Profile</a></li>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8 tabular-border">
                                                                        <!--<input type="button" class="form-control"
                                                                               id="userCurrentPassword" name="userCurrentPassword"
                                                                               placeholder="Enter Current Password Here">-->
                                                                        <a class="btn btn-lg btn-info btn-block"
                                                                           id="passwordChange" type="button" href="#">Change
                                                                            Password</a>
                                                                    </div>
                                                                </div>
...
<script type="text/javascript" src="profileForUser.js"></script>
<?php
}
else {
