...
<center>
    ...
    <div id='groupStatus'>
        <div id="grouppStatus2">
            <h3 id="test">You have been added to Group <b><span class="textGroupInfo">
                        <a href="userGroup.php"><?= $result['group_name'] ?></a></span></b> By <span
                    class="textGroupInfo">
                <?php
