...
class dailyCostApprovalFetch extends oodbconfig
{
...
if ($_SERVER['REQUEST_METHOD']=="POST"){
    $dailyCostApprovalFetch = new dailyCostApprovalFetch();
    if (isset($_POST['specificDate'])){

        $dailyCostApprovalFetch->setSpecificBazarDateData($_POST['specificDate']);
    }
    if (isset($_POST['showSpecificDateBazarDetails'])){
        ...
        $dailyCostApprovalFetch->setSpecificBazarDateData($specifiedDate);
    }
}
?>