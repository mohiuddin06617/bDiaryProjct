...
<div class="search-wrapper">
    <form action="" method="get" name="search">
        <div class="search-box">
            ...
            <input name="search" id="searchInput" type="text" placeholder="Search by Users Email" onkeyup="searchResult(this.value)"/>
...
/*
            $("#searchAnswer").html("<img alt="ajax search" src='Resource/ajax-loader.gif'/>");
*/
            if (str != 0) {
                $.ajax({
                    type: 'POST',
                    url: 'searchBoxCode.php',
                    data: 'searchQuery=' + str,
                    success: function (data) {
                        $("#searchAnswer").html(data);
                    }
                });
            }
            else if(searchQuery==""){
