...
if (isset($_SESSION['managerID']) && !empty($_SESSION['managerID']) && !empty($_SESSION['email']) && $_SESSION['userStatus'] === 1) {
include_once "dailyFoodMenuSelectionFetch.php";
$dailyFoodMenuSelectionFetch=new dailyFoodMenuSelectionFetch();
    ?>
    <head>
        <meta charset="utf-8">
                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="dailyFoodMenuSelection.php">Manager Food Menu Selection</a></li>
                        </ol>
                        <div class="container-fluid">
                                                        ...
                                                        <div class="panel panel-info"
                                                            ...
                                                            <div class="panel-body no-padding">
                                                                <table class="table table-striped table-fill">
                                                                    ...
                                                                    <?php
                                                                    if (!empty($dailyFoodMenuSelectionFetch->getTodayBreakfastFoodMenuList())) {
                                                                        foreach ($dailyFoodMenuSelectionFetch->getTodayBreakfastFoodMenuList() as $item) {
                                                                            if ($item != null) {
                                                                                echo "<tr><td>" . $item . "</td><td>" . date('Y-m-d') . "</td><td><button class='btn btn-info'>Edit</button></td></tr>";
                                                                            }
                                                                        }
                                                                    }
                                                                    else{
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2" id="totalNoOfBreakfast">5</td>
                                                                    </tr>
                                                                    </tfoot>
                                                                </table>
                                                            </div>
                                                        ...
                                                        <div class="panel panel-info"
                                                            ...
                                                            <div class="panel-body no-padding">
                                                                <table class="table table-striped table-fill">
                                                                    ...
                                                                    <?php
                                                                    if (!empty($dailyFoodMenuSelectionFetch->getTodayLunchFoodMenuList())) {
                                                                        foreach ($dailyFoodMenuSelectionFetch->getTodayLunchFoodMenuList() as $item) {
                                                                            if ($item != null) {
                                                                                echo "<tr><td>" . $item . "</td><td>" . date('Y-m-d') . "</td><td><button class='btn btn-info'>Edit</button></td></tr>";
                                                                            }
                                                                        }
                                                                    ...
                                                                    <tr>
                                                                        <td>Total No Of meal</td>
                                                                        <td colspan="2" id="totalNoOfLunch">5</td>
                                                                    </tr>
                                                                    </tfoot>
                                                                </table>
                                                            </div>
                                                        ...
                                                        <div class="panel panel-info"
                                                            ...
                                                            <div class="panel-body no-padding">
                                                                <table class="table table-striped table-fill">
                                                                    ...
                                                                    <?php
                                                                    if (!empty($dailyFoodMenuSelectionFetch->getTodayDinnerFoodMenuList())) {
                                                                        foreach ($dailyFoodMenuSelectionFetch->getTodayDinnerFoodMenuList() as $item) {
                                                                            if ($item != null) {
                                                                                echo "<tr><td>" . $item . "</td><td>" . date('Y-m-d') . "</td><td><button class='btn btn-info'>Edit</button></td></tr>";
                                                                            }
                                                                        }
                            ...
                            <div class="panel panel-blue" data-widget='{"draggable": "false"}'>
                                ...
                                <div class="panel-body">
                                    ...
                                    <br>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-1"></div>
    ...
    <script type="text/javascript" src="assets/plugins/jquery-tabledit-1.2.3/jquery.tabledit.js"></script>
    <script src="assets/js/food_menu_dynamic_table_edit_js.js"></script>
    <script src="assets/js/statusManagement.js"></script>

    <script src="dailyFoodMenuSelection.js"></script>
