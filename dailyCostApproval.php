...
if ((isset($_SESSION['managerID']) &&
                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="dailyCostApproval.php">Manager Daily Cost Handling</a></li>
                        </ol>
                        <div class="container-fluid">
                            <?php
                            include_once "dailyCostApprovalFetch.php";
    ...
    <script src="dailyCostApproval.js"></script>
